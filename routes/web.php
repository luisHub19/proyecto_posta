...
Route::get('home/{idnoticia}', [SeccionController::class, 'nota']) ->name ('noticia');
...
Route::get('home/{idnoticia}', [App\Http\Controllers\NotaController::class, 'mostrarNoticiaNoticiaC'])->name('nota');
